...
with_node \
  ...
  --target "/Users/saumyajain/Desktop/REACT:EXPO/FinalWorking-BloomAccess/BloomAccess/ios/Pods/Target Support Files/Pods-BloomAccess/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake"
